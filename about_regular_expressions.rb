...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # = when asterisk doesn't have any letter on the left side
  end
  ...
  #
  # Why?
  # = cant't understand that word right now, but I suposse is about iterating over character inside string
  ...
  # = it works the same, but (|) can group words, ([...]) only characters
