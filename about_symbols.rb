...
class AboutSymbols < EdgeCase::Koan
  ...
  # = symbols are unique, the oposite way will create the symbol that I want to find, so always will be true
  ...
  # = each string concat create a new string, that need to be parsed to a symbol
end
